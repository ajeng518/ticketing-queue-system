...
public class WaitingRoomController {
    ...
    Mono<Rendering> waitingRoomPage(@RequestParam(name = "queue", defaultValue="default") String queue, @RequestParam(name="user-id") Long userId, @RequestParam(name="redirect_url") String redirectUrl){
